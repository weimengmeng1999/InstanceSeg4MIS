...
args = train_config_vit.get_args()
...
optimizer = torch.optim.SGD(
        model.parameters(),
        args['lr'] * (16 * 1) / 16.,  # linear scaling rule
        momentum=0.9,
...
scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(optimizer, args['n_epochs'], eta_min=0)
